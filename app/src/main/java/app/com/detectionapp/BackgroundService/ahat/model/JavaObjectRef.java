...
/**
 * A forward reference to an object.  This is an intermediate representation for a JavaThing, when we have the thing's ID, but we might not
 * have read the thing yet.
 *
 * @author Bill Foote
 */
