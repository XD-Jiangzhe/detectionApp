...
import app.com.detectionapp.BackgroundService.ahat.util.CompositeEnumeration;
...
public class JavaClass extends JavaHeapObject {
    ...
    /**
     * Resolve our superclass.  This might be called well before all instances are available (like when reading deferred instances in a 1.2
     * dump file :-)  Calling this is sufficient to be able to explore this class' fields.
     */
