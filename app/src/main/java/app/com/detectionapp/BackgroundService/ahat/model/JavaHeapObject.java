...
/**
 * Represents an object that's allocated out of the Java heap.  It occupies memory in the VM, and is the sort of thing that in a JDK 1.1 VM
 * had a handle.  It can be a JavaClass, a JavaObjectArray, a JavaValueArray or a JavaObject.
 */
...
public abstract class JavaHeapObject extends JavaThing {
    ...
    /**
     * Do any initialization this thing needs after its data is read in. Subclasses that override this should call super.resolve().
     */
    ...
    /**
     * @return the StackTrace of the point of allocation of this object, or null if unknown
     */
    ...
    /**
     * If the rootset includes this object, return a Root describing one of the reasons why.
     */
    public Root getRoot() {
