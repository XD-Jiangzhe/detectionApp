...
/**
 * This represents a set of data members that should be excluded from the reachable objects query. This is useful to exclude observers from
 * the transitive closure of objects reachable from a given object, allowing some kind of real determination of the "size" of that object.
 *
 * @author Bill Foote
 */
public class ReachableExcludesImpl implements ReachableExcludes {
    ...
    /**
     * Create a new ReachableExcludesImpl over the given file.  The file will be re-read whenever the timestamp changes.
     */
    ...
    /**
     * @return true iff the given field is on the histlist of excluded fields.
     */
